  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        // Prefer stored token from login; fallback to cookie-based get-token if missing
      ...
      {loading ? (
        ...
        <ScrollView>
          {graduate?.profilePicture ? (
            <Image
              source={{ uri: graduate.profilePicture as string }}
          ...
          <TextInput
            ...
            multiline
            style={{ borderWidth: 1, padding: 8, marginBottom: 8, minHeight: 60 }}
          />
